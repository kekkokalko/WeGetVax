...
/**
 * NuovaPrenotazioneController è la classe che definisce il controller dell'operazione di aggiunta di una nuova prenotazione da parte di un vaccinando. Tale prenotazione sarà
 * visualizzata, insieme alle altre prenotazioni all'interno della sezione dedicata.
 */
public class NuovaPrenotazioneController implements Initializable {
    ...
    /**
     * Metodo che permette, dopo aver compilato correttamente gli appositi campi, di aggiungere una nuova prenotazione all'interno del Db. Quest'ultima operazione è
    ...
    /**
     * Metodo che inserisce la nuova prenotazione definita all'interno del Db.
     */
